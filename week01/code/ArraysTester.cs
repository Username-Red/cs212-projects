public static class ArraysTester {
    ...
    private static double[] MultiplesOf(double number, int length)
    {
        ...
        // Use a for loop that loops an amount of times equal to 'length', 
        // each time adding the value of 'number' to a variable, 
        // replaces the new variable to the appropriate position in the list of multiples, 
        // and then returns the final list after the loop is finished


        double multiple = 0;
        // List<double> multiples = new List<double>();
        double[] doom = new double[length];
        ...
        return doom; // replace this return statement with your own
    }
